"""
Script cao anh giay dep tu Pexels (https://www.pexels.com/search/shoes/)
...
- Luu vao: D:/Java/order-system/images/product/shoes
...
# CAU HINH
# ─────────────────────────────────────────────
SAVE_DIR     = Path(r"D:\Java\order-system\images\product\shoes")
TARGET_COUNT = 100
TARGET_URL   = "https://www.pexels.com/search/shoes/"
MIN_SIZE_KB  = 20
HEADLESS     = False
...
async def main():
    ...
    for url in all_urls:
        ...
        file_name = f"shoes_{downloaded + 1:03d}.jpg"
