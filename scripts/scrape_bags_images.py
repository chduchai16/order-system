"""
Script cao anh tui xach tu Pexels (https://www.pexels.com/search/bags/)
- Playwright + stealth JS de bypass bot detection
- Intercept network request -> bat URL anh truc tiep
- Luu vao: D:/Java/order-system/images/product/bags
...
# CAU HINH
# ─────────────────────────────────────────────
SAVE_DIR     = Path(r"D:\Java\order-system\images\product\bags")
TARGET_COUNT = 100
TARGET_URL   = "https://www.pexels.com/search/bags/"
MIN_SIZE_KB  = 20
HEADLESS     = False
...
async def main():
    ...
    for url in all_urls:
        ...
        file_name = f"bags_{downloaded + 1:03d}.jpg"
