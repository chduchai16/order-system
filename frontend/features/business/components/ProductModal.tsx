...
import { Product, ProductVariant, ProductAttribute } from '@/features/shared/types';
import { X, Plus, Trash2, Tag, Layers, Settings, FileText } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="bg-[#FDFAF7] border border-[#EAE3D2] rounded-3xl shadow-2xl w-full max-w-2xl h-[90vh] md:h-auto md:max-h-[85vh] flex flex-col overflow-hidden relative z-10 animate-fade-in font-sans">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="pt-4 border-t border-[#EAE3D2]/50 flex justify-end gap-3 bg-[#FDFAF7] sticky bottom-0 z-10 py-2">
            <button
              type="button"
              onClick={onClose}
            ...
            >
              {submitting ? 'Đang lưu...' : (product ? 'Cập nhật tác phẩm' : 'Đăng bán ngay')}
            </button>
          </div>
        </form>
      </div>
