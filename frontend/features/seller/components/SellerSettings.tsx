...
export default function SellerSettings() {
  ...
  useEffect(() => {
    const loadSettings = () => {
      const data = sellerSettingsService.getShopSettings();
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="flex gap-4.5 items-start">
              ...
              <div className="min-w-0 text-left -mt-2">
                <h4 className="font-serif font-black text-sm text-gray-855 truncate leading-snug">{shopName || 'Tên gian hàng'}</h4>
