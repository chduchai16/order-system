    ...
    <div className="space-y-16">
          ...
          {vintageFinds.map((item) => (
            <Link key={item.title} href="/products" className="group flex flex-col cursor-pointer bg-white border border-[#EAE3D2]/40 rounded-xl overflow-hidden hover:shadow-md transition-all duration-300">
              ...
              <div className="p-3 text-left">
                ...
                <h4 className="font-semibold text-xs text-gray-850 line-clamp-1 leading-snug group-hover:text-[#F1641E] transition-colors" title={item.title}>
                  {item.title}
                </h4>
              </div>
            </Link>
        ...
        <div className="px-5 py-4 border-b border-[#EAE3D2]/50 flex flex-wrap items-center justify-between gap-3 bg-[#F5EFE6]/30">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-[11px] text-gray-505">Ưu đãi độc quyền giới hạn số lượng và thời gian</p>
            </div>
          </div>
              ...
              <div className="p-4 flex-grow flex flex-col justify-between text-left">
                ...
                <div className="pt-4">
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xs text-gray-455 line-through font-medium">{product.oldPrice}</span>
                  </div>
      ...
      <section className="bg-[#F5EFE6]/30 border border-[#EAE3D2]/50 rounded-2xl p-8 md:p-12 text-center space-y-8">
        <div className="max-w-xl mx-auto space-y-2">
          ...
          <p className="text-xs md:text-sm text-gray-650 font-serif italic">Nơi trao gửi tình yêu thủ công nghệ thuật và sự độc bản</p>
        </div>
