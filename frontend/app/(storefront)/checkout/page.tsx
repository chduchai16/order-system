...
import { Address, CreateOrderRequest, PageResponse, Voucher } from '@/components/types';
...
export default function CheckoutPage() {
  ...
  const loadMoreVouchers = async () => {
    ...
    try {
      ...
      const response = await voucherService.getVouchers(voucherCode, nextPage, VOUCHER_PAGE_SIZE);
