...
export default function Header() {
  ...
  return (
    <header className="w-full bg-[#FDFAF7] border-b border-[#EAE3D2]/60 sticky top-0 z-50">
      ...
      {/* Main Header */}
      <div className="max-w-screen-2xl mx-auto px-4 py-3 md:py-4 flex items-center justify-between gap-4 md:gap-8">
                  ...
                  <div className="absolute right-0 mt-2.5 w-60 bg-white border border-[#EAE3D2]/60 rounded-2xl shadow-xl py-3 px-1 z-40 animate-fade-in font-sans">
                    ...
                    <div className="py-1.5">
                      <Link 
                        ...
                        className="flex items-center gap-2.5 px-4 py-2 text-xs font-semibold text-gray-650 hover:bg-[#F5EFE6]/35 hover:text-black transition-colors cursor-pointer"
                      >
                    ...
                    <div className="border-t border-gray-100 pt-2 px-3">
                      <button
                        ...
                        className="w-full py-2 text-center bg-red-50 hover:bg-red-100 text-red-650 hover:text-red-700 rounded-full text-[11px] font-bold transition-colors cursor-pointer flex items-center justify-center gap-1.5"
                        type="button"
                      >
      ...
      <nav className="border-t border-[#EAE3D2]/40 hidden md:block bg-[#FDFAF7]/85 backdrop-blur-sm">
        <div className="max-w-screen-2xl mx-auto px-4 flex justify-center space-x-1.5 lg:space-x-4 overflow-x-auto no-scrollbar py-2 text-xs font-semibold text-gray-700">
          ...
          <div className="w-72 bg-[#FDFAF7] h-full p-6 flex flex-col space-y-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <ul className="space-y-4 font-semibold text-sm text-gray-700 flex-1 overflow-y-auto">
              ...
              <li className="border-t border-gray-200/80 pt-3 mt-2">
                <Link href="/seller" onClick={() => setShowMobileMenu(false)} className="flex items-center gap-2 py-1 text-[#1E5C3F] font-bold">
